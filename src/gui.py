...
class MainWindow(QMainWindow):
    ...
    def init_ui(self):
        ...
        btn_camera = QPushButton("📷 摄像头扫描")
        btn_camera.setMinimumHeight(40)
        btn_camera.setStyleSheet("background-color: #2196F3; color: white;")
        btn_camera.clicked.connect(self.open_camera_scanner)
    ...
    def open_camera_scanner(self):
        """打开摄像头扫描窗口"""
        camera_dialog = CameraScanner(self)
        camera_dialog.exec_()
    ...
    def show_debug(self):
        ...
        self.debug_window.setWindowTitle("调试 - 处理过程")
        self.debug_window.setMinimumSize(1400, 500)

        layout = QHBoxLayout(self.debug_window)
